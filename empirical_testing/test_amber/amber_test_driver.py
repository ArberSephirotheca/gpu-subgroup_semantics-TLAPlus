...
def main():
    ...
    default_cfg = Configuration(timeout=2000, workgroups=65532, threads_per_workgroup=32, saturation_level=0, subgroup=0, subgroup_size=32)
    round_r_cfg = Configuration(timeout=2000, workgroups=65532, threads_per_workgroup=32, saturation_level=1, subgroup=0, subgroup_size=32)
    chunk_cfg = Configuration(timeout=2000, workgroups=65532, threads_per_workgroup=32, saturation_level=2, subgroup=0, subgroup_size=32)
