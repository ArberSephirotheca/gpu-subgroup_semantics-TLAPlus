...
def main():
    ...
    waterfall_cfg = Configuration(timeout=2000, workgroups=65532, threads_per_workgroup=128, saturation_level=3, subgroup=0, subgroup_size=32)
    global_barrier_cfg = Configuration(timeout=2000, workgroups=65532, threads_per_workgroup=128, saturation_level=4, subgroup=0, subgroup_size=32)
